...
#
# Stabilization-alternative baseline: VANILLA GRPO + adaptive KL control (algorithm.kl_ctrl.type=
# adaptive), targeting algorithm.kl_ctrl.target_kl, in reward. This is the other common
# off-the-shelf alternative to Dr. MAS for taming gradient spikes/policy-update instability
# (see run_math_gradclip_0.5.sh / _0.2.sh / _0.1.sh for the grad_clip sweep, and
# run_math_std_tracking.sh for Dr. MAS itself).
...
experiment_name="drmas_adaptivekl_${model_name_tag}"
