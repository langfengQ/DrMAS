...
#
# Stabilization-alternative baseline: VANILLA GRPO + stronger gradient clipping (grad_clip=0.5),
# one of three grad_clip values swept as an alternative to Dr. MAS
# (see run_math_gradclip_0.2.sh, run_math_gradclip_0.1.sh, and run_math_std_tracking.sh for Dr. MAS).
