...
#
# Stabilization-alternative baseline: VANILLA GRPO + stronger gradient clipping (grad_clip=0.1),
# one of three grad_clip values swept as an alternative to Dr. MAS
# (see run_math_gradclip_0.5.sh, run_math_gradclip_0.2.sh, and run_math_std_tracking.sh for Dr. MAS).
